# Tanzania PHI Tool Shiny App
 
This repository is set up with **renv** for reproducible R environments and includes templates for Word reports and convenience scripts.
